...
const REGLAS: readonly Regla[] = [
  { campo: 'tag', patrones: [/^tag$/, /^tag\s*id$/, /^tagid$/, /equip.*tag/, /id\s*equip/, /n[º°]\s*tag/, /tag\s*equip/] },
  ...
  { campo: 'arranque', patrones: [/arranque/, /starter/, /partidor/, /tipo\s*partidor/, /starter\s*type/] },
