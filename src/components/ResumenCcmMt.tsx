  ...
  return (
    <div className="grid sm:grid-cols-2 gap-4">
      <div className="border border-slate-200 dark:border-slate-800 rounded-lg p-4">
        <div className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-2">Tablero y celdas principales</div>
        <dl className="grid grid-cols-2 gap-y-1 text-sm">
          <dt className="text-slate-500 dark:text-slate-400">Columnas (con entrada y medida)</dt>
          <dd className="font-medium tabular-nums">{t.columnas.length + 2}</dd>
          <dt className="text-slate-500 dark:text-slate-400">Interruptor de entrada</dt>
          ...
          <dt className="text-slate-500 dark:text-slate-400">Relé de entrada</dt>
          <dd className="font-mono text-xs">{t.proteccionEntrada.ansi.join(' · ')}</dd>
          <dt className="text-slate-500 dark:text-slate-400">Celda de medida</dt>
          ...
          <dt className="text-slate-500 dark:text-slate-400">FLA total</dt>
          <dd className="font-medium tabular-nums">{fmtAmp(t.corrienteTotalA)}</dd>
          {derrateo.activo && (
            <>
              <dt className="text-slate-500 dark:text-slate-400">Altitud</dt>
              <dd className="font-medium tabular-nums">{fmtNumero(derrateo.altitudM)} m.s.n.m.</dd>
              <dt className="text-slate-500 dark:text-slate-400">Factor F2 (MT)</dt>
              <dd className="font-medium tabular-nums">{fmtFactor(t.factorDerrateoAltura)}</dd>
              <dt className="text-slate-500 dark:text-slate-400">I selección equipo</dt>
      ...
      <div className="border border-slate-200 dark:border-slate-800 rounded-lg p-4">
        <div className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-2">Conteo de contactores</div>
        <ul className="space-y-1 text-sm">
          ...
          <li className="flex justify-between border-t border-slate-200 dark:border-slate-800 pt-1 mt-2">
            <span className="text-slate-500 dark:text-slate-400">Total asignaciones</span>
