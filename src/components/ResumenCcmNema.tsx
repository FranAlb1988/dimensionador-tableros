    ...
    <div className="grid sm:grid-cols-2 gap-4">
      <div className="border border-slate-200 dark:border-slate-800 rounded-lg p-4">
        ...
        <dl className="grid grid-cols-2 gap-y-1 text-sm">
          ...
          <dt className="text-slate-500 dark:text-slate-400">X por columna</dt>
          <dd className="font-medium tabular-nums">{xPorColumna}X (X = {fmtMm(t.xMm)})</dd>
          <dt className="text-slate-500 dark:text-slate-400">X usados</dt>
      ...
      <div className="border border-slate-200 dark:border-slate-800 rounded-lg p-4">
        <div className="text-sm font-medium text-slate-500 dark:text-slate-400 mb-2">Conteo</div>
        {conteoSize.size > 0 && (
          <>
            <div className="text-xs text-slate-500 dark:text-slate-400 mb-1">Contactores NEMA</div>
        ...
        {conteoFrame.size > 0 && (
          <>
            <div className="text-xs text-slate-500 dark:text-slate-400 mb-1">Breakers (alimentadores)</div>
