  ...
  return (
    <div className="border border-slate-200 dark:border-slate-800 rounded-lg p-4">
      ...
      <dl className="grid grid-cols-2 gap-y-1 text-sm">
        <dt className="text-slate-500">Potencia nominal</dt>
        <dd
          className={
        ...
        <dt className="text-slate-500">Tensión</dt>
        ...
        {r.paralelo && (
          <>
            ...
            <dt className="text-slate-500">{r.paralelo.cantidad} unidades de</dt>
            <dd className="font-medium tabular-nums">
              {r.paralelo.cadaUno.kvaNominal} kVA c/u
            </dd>
            <dt className="text-slate-500">I sec. / unidad</dt>
            <dd className="font-medium tabular-nums">
